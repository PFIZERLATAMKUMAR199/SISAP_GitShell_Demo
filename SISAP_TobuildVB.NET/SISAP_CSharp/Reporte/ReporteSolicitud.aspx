...
<body>
    ...
    <div>
      ...
      <%--  <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="1200px" Width="100%">
            <LocalReport ReportEmbeddedResource="Solicitud.rdlc" ReportPath="Solicitud.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSet1_DataTable1" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="SISAP_VB.DataSet1TableAdapters.fn_SISAP_SUNDB433_VE_P_SSRFANVTableAdapter">
           <SelectParameters>
                <asp:SessionParameter Name="cod_Proceso" SessionField="Proceso_Reporte" Type="Int32" />
            </SelectParameters>
        </asp:ObjectDataSource>
