...
Partial Class Index
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If (ddlAprob1.SelectedValue = String.Empty) Then
                ...
                Dim ad1 As New ADAuthorizationUtil()
                tabla1 = ad1.GetMembersFromADGroup(ADAuthorizationUtil.SISAPPAprobadorL)
            ...
            If (ddlAprob2.SelectedValue = String.Empty) Then
                ...
                Dim ad2 As New ADAuthorizationUtil()
                tabla2 = ad2.GetMembersFromADGroup(ADAuthorizationUtil.SISAPSAprobadorL)
    ...
    Private Sub cargar_solicitud(ByVal cod_proceso As Integer)
        ...
        If Session("ADGroup") = Nothing Then
            ...
            Return
        Else
            ds = tabla.Existe(Session("ADGroup"))
        End If

        Dim Nombre As String
        Dim NTID As String

        'Verificando que el usuario este autorizado  
        Nombre = Session("NOMBRE").ToString()
        NTID = Session("UserNTID").ToString()
        'SISAP Code end
            ...
            Select Case Session("perfil")
                ...
                Case 4
                    ...
                    For Each row_prov In ds_prov.Tables("tabla2").Rows
                        ...
                        'SISAP Change Start
                        Dim ad3 As New ADAuthorizationUtil()
