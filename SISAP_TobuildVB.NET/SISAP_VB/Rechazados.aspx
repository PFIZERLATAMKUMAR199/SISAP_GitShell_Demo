        ...
        <tr>
            <td style="text-align: center; height: 291px; vertical-align: top;">
                ...
                <%--<asp:SqlDataSource ID="SqldsAprobaciones" runat="server" ConnectionString="<%$ ConnectionStrings:SISAPConnectionString %>"
                 ...
                 <asp:SqlDataSource ID="SqldsAprobaciones" runat="server" ConnectionString="<%$ ConnectionStrings:SISAPConnectionString %>"
                    SelectCommand="SELECT A.COD_PROCESO, A.RIF, A.RAZON_SOCIAL, A.MOTIVO_RECHAZO, @NOMBRE, 'Index.aspx?cod_Proceso=' + CONVERT (VARCHAR, A.COD_PROCESO) AS URL, CONVERT (DATETIME, A.FECHA_RECHAZO, 103) AS FECHA_RECHAZO FROM dbo.PROVEEDOR WHERE (A.COD_ESTATUS = 4) AND (A.COD_SOLICITANTE = @USUARIO)">
                    <SelectParameters>
